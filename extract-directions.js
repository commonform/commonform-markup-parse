...
// Given the AST produced by the parser, replace all blanks with `{ blank:'' }`
// and create directions that link blank identifiers to paths within the form.
function extractDirections(syntaxTree) {
